...
public class InformationScript : MonoBehaviour
{
    ...
    string s4 = "Steps\n\n"+"1. Switch on the coolant pumps. Once the coolant has reached 290 degree celsius go to step 2.\n\n"+ "2. Lift the control rods into the designated zone. This will heat the reactor, and in turn will increase the coolant temperature.\n\n";
    string s5 = "3. Increase the steam output from the steam generators to turn the turbines and produce electricity. The power demand will change over time. Match the output to the power demand while maintaining coolant temperature by adjusting the control rods and steam output.\n\n4. Keep the gauges in the green to increase your score. 1 point is gained every second for each gauge in the green. If any gauge is in the red, no points can be scored";
